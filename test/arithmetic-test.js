...
describe("BN.js/Arithmetic", function () {
  ...
  function testMethod(name, mul) {
    describe(name, function () {
      ...
      it("should multiply neg number on 0", function () {
        assert.equal(
          mul(new BN("-100000000000"), new BN("3").div(new BN("4"))).toString(
            16
          ),
          "0"
        );
  ...
  describe(".muln()", function () {
    ...
    it("should negate number if number is negative", function () {
      ...
      assert.equal(
        a.clone().imuln(-1).toString(16),
        a.clone().neg().toString(16)
      );
      assert.equal(
        a.clone().muln(-1).toString(16),
        a.clone().neg().toString(16)
      );
  ...
  describe(".div()", function () {
    ...
    it("should divide large numbers (>53 bits)", function () {
      assert.equal(
        new BN("1222222225255589").div(new BN("611111124969028")).toString(10),
        "1"
      );
      assert.equal(
        new BN("-1222222225255589").div(new BN("611111124969028")).toString(10),
      ...
      assert.equal(
        new BN("-1222222225255589")
          .div(new BN("-611111124969028"))
          .toString(10),
        "1"
      );

      assert.equal(
        new BN("611111124969028").div(new BN("1222222225255589")).toString(10),
        "0"
      );
      assert.equal(
        new BN("-611111124969028").div(new BN("1222222225255589")).toString(10),
      ...
      assert.equal(
        new BN("-611111124969028")
          .div(new BN("-1222222225255589"))
          .toString(10),
        "0"
      );
    });
  ...
  describe(".mod()", function () {
    ...
    it("should modulo large numbers (>53 bits)", function () {
      assert.equal(
        new BN("1222222225255589").mod(new BN("611111124969028")).toString(10),
        "611111100286561"
      );
      assert.equal(
        new BN("-1222222225255589").mod(new BN("611111124969028")).toString(10),
      ...
      assert.equal(
        new BN("-1222222225255589")
          .mod(new BN("-611111124969028"))
          .toString(10),
        "-611111100286561"
      );

      assert.equal(
        new BN("611111124969028").mod(new BN("1222222225255589")).toString(10),
        "611111124969028"
      );
      assert.equal(
        new BN("-611111124969028").mod(new BN("1222222225255589")).toString(10),
